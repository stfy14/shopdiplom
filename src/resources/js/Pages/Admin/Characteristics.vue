...
<template>
    <div>
        <div class="flex items-start sm:items-center gap-4 mb-6">
            ...
            <h1 class="text-xl sm:text-2xl font-black text-gray-900 leading-tight">Управление характеристиками</h1>
        </div>
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <input
                        ...
                        class="flex-grow px-4 py-3 bg-white rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none text-sm font-bold transition shadow-sm"
                        :class="{ 'border-red-400': form.errors.name }"
                    />
                    <button @click="submit" :disabled="form.processing" class="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition shadow-sm disabled:opacity-50 whitespace-nowrap">
                        Добавить
                    </button>
                </div>
            </div>
