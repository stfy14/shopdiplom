...
<template>
    <div>
        <div class="flex sm:inline-flex flex-wrap gap-1 mb-6 p-1 bg-white border border-gray-100 rounded-xl shadow-sm">
            <Link 
                href="/admin/orders" 
                :class="['grow sm:grow-0 flex items-center justify-center gap-2 px-5 py-2.5 sm:py-2 rounded-lg text-sm font-bold transition whitespace-nowrap', tab === 'active' ? 'bg-blue-600 text-white' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50']"
            >
            ...
            <Link 
                ...
                :class="['grow sm:grow-0 flex items-center justify-center gap-2 px-5 py-2.5 sm:py-2 rounded-lg text-sm font-bold transition whitespace-nowrap', tab === 'completed' ? 'bg-emerald-500 text-white' : 'text-gray-500 hover:text-emerald-600 hover:bg-emerald-50']"
            >
            ...
            <Link 
                ...
                :class="['grow sm:grow-0 flex items-center justify-center gap-2 px-5 py-2.5 sm:py-2 rounded-lg text-sm font-bold transition whitespace-nowrap', tab === 'archive' ? 'bg-red-500 text-white' : 'text-gray-500 hover:text-red-500 hover:bg-red-50']"
            >
