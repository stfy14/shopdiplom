    ...
    <div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
            ...
            <div class="mb-6">
                ...
                <select v-model="form.category_id" class="w-full px-4 py-3 bg-white rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none text-sm font-bold transition shadow-sm">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center gap-5 p-5 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <input type="file" accept="image/*" @change="onImageChange" class="text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-sm file:font-bold file:bg-white file:border-gray-200 file:border file:text-gray-700 hover:file:bg-gray-50 file:transition cursor-pointer file:shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
            </div>

            <button @click="submit" :disabled="form.processing" class="w-full py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition shadow-md shadow-blue-200 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
